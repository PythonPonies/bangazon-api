...
def load_product_categories(apps, schema_editor):
    ...
    Product_Category = apps.get_model("bangazonapi", "Product_Category")
    product_category_1 = Product_Category(category_name="shoes")
    product_category_2 = Product_Category(category_name="books")
    product_category_3 = Product_Category(category_name="movies")
...
def load_users(apps, schema_editor):
    ...
    user_1 = User(first_name="Steve", last_name="Brownlee", shipping_address="x", email="s@b.com", phone="x")
    user_1 = User(first_name="Joey", last_name="Kirby", shipping_address="x", email="j@k.com", phone="x")
...
def load_payment_types(apps, schema_editor):
    ...
    payment_type_1 = Payment_Type(account_number="54545454", billing_address="X", payment_type="mastercard")
    payment_type_2 = Payment_Type(account_number="54545454", billing_address="X", payment_type="mastercard")
    payment_type_3 = Payment_Type(account_number="54545454", billing_address="X", payment_type="mastercard")
