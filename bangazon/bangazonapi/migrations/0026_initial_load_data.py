...
def load_categories(apps, schema_editor):
    '''load_orders loads initial seed data for Order table on makemigrations'''
    Category = apps.get_model("bangazonapi", "Category")
    category_1 = Category(category_name="shoes")
    category_2 = Category(category_name="books")
    category_3 = Category(category_name="movies")
